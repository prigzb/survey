...
function onRequest(request, response){
 ...
 str=fs.readFileSync('./entrance.json');
 response.write(str);
 response.end();
}
...
// router.get('/entrance.json', function (req, res, next) {
//     return new Promise(function (resolve, reject) {
//         const adminConfig = JSON.parse(fs.readFileSync('./entrance.json'));
//         console.log(adminConfig, '111111111111111111')
//         if (adminConfig) {
//             resolve(adminConfig)
//         } else {
//             reject(adminConfig)
